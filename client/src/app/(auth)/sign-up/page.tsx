            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="text"
                  required
                  className="block w-full rounded-md border-0 py-1.5  shadow-sm text-slate-600 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-md border-0 py-1.5 text-slate-600  shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2"
                />
              </div>
            </div>
