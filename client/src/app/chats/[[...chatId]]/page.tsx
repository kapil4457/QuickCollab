...
const page = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] grid grid-cols-10 mt-[6rem]">
      ...
      <div className="hidden lg:block col-span-2 p-2 h-[calc(100vh-6rem)] border border-l-2 ">
      ...
      <div className="flex flex-col col-span-10 lg:col-span-8">
        <div className="h-[5rem] flex justify-between pl-7 pr-7  md:pl-12 md:pr-12 ">
          {/* {currentChat && ( */}
          <>
            {currentChat && (
              <>
                ...
                <>
                  ...
                  <Dialog>
                    <DialogTrigger>
                      ...
                      <Button
                        variant={"secondary"}
                        className=" gap-2 text-green-400 hidden md:flex"
                      >
                        <GroupAddIcon />
                      </Button>
                    </DialogTrigger>
